...
export const Projects = () => {
    return (
        ...
        <div className="mx-auto px-4 mb-20" id='tech'>
                ...
                <div className="space-y-24">
                    {ProjectsData.map((project, i) => (
                        ...
                        <div key={i} className="flex justify-end space-x-6">
                            <h1 className="font-normal text-gray-500 hidden text-3xl md:text-4xl md:block">{i + 1}</h1>
                            <span className="w-28 h-0.5 bg-orange-300 mt-5 hidden md:block"></span>
